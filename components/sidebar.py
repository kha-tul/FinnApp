...
# ========= Layout ========= #
layout = dbc.Col([
        html.H1("$$Planner", className="text-primary"),
        html.P("Organização Financeira", className="text-info"),
        html.Hr(),
...
dbc.ModalBody([
        dbc.Row([ 
            dbc.Col([
                dbc.Label('Descrição: '),
                dbc.Input(placeholder="Ex.: dividendos da bolsa, cryptos...", id="text-receita"),
            ], width=6),
            dbc.Col([
                dbc.Label("Valor: "),
...
dbc.ModalBody([
    dbc.Row([
        dbc.Col([
            dbc.Label('Descrição: '),
            dbc.Input(placeholder="Ex.: contas, gastos de última hora,...", id="txt-despesa"),
        ], width=6),
        dbc.Col([
            dbc.Label("Valor: "),
    ...
    dbc.Row([
        dbc.Col([
            dbc.Label("Data: "),
            dcc.DatePickerSingle(id='date-desepsas',
